 ...
 *
 * One place to manage the site's CTAs (e.g. "Reach out →",
...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      description:
        'A label just for this list — not shown on the site. Helps you find this CTA when linking it from a page (e.g. "Primary — Reach out").',
    ...
    defineField({
      ...
      title: 'Button label',
      type: 'string',
      description: 'The text on the button (e.g. "Reach out →").',
